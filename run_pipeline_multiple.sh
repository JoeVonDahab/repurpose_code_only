...
# FEN1
protein_path="jobs/benchmarking/FEN1/5fv7_FEN1.pdb" # your protein 
output_path="jobs/benchmarking/FEN1/5fv7_FEN1_output" # output path for the results
sdf_files="diffdock/ligand_sdf_files_FEN1_5P/" # path to the sdf files to be docked
smiles_file="diffdock/FEN1_5P.smi" # path to the smiles file of the library
...
# FEN1
protein_path="jobs/benchmarking/GBA/2v3d_GBA.pdb" # your protein 
output_path="jobs/benchmarking/GBA/2v3d_GBA_output" # output path for the results
sdf_files="diffdock/ligand_sdf_files_GBA_5P/" # path to the sdf files to be docked
smiles_file="diffdock/GBA_5P.smi" # path to the smiles file of the library
